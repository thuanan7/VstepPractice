...
const SpeakingSection = (props: SpeakingSectionProps) => {
  const { part } = props
  ...
  const startRecording = async () => {
    ...
    try {
      ...
      alert(
        'Unable to access the microphone. Please check your device settings.',
      )
    }
  }
  ...
  const sendAudioToAPI = async () => {
    ...
    try {
      const response = await fetch(
        'http://localhost:3000/api/transcribe-and-chat',
        {
          method: 'POST',
          body: formData,
        },
  ...
  return (
    <>
      ...
      <Grid container spacing={4}>
        ...
        {/*    <b>{currentPart.title}</b>*/}
        {/*    <br />*/}
        {/*    <b>{currentPart.questionText}</b>*/}
        {/*  </Typography>*/}
        {/*  {currentPart.questions.map((question) => (*/}
        {/*    <Box key={question.id} sx={{ mt: 2 }}>*/}
        {/*      {currentPart.id === 'S3' ? <b>Follow-up questions: </b> : ''}*/}
        {/*      <br />*/}
        {/*      {currentPart.id === 'S3' ? (*/}
        {/*        <b>Note: {question.questionText}</b>*/}
        {/*      ) : (*/}
        {/*        <b>{question.questionText}</b>*/}
        {/*      )}*/}
        {/*      <Typography>*/}
        {/*        {question.options?.map((option, _) => <p>- {option}</p>)}*/}
        {/*      </Typography>*/}
        {/*    </Box>*/}
        {/*  ))}*/}
        {/*</Grid>*/}
